...
/// Floating notch + expandable panel that shows workbench server URLs.
///
/// Renders as a [Positioned] widget — place inside a [Stack] or [Overlay].
/// Hides itself (returns [SizedBox.shrink]) when the server is not running.
...
class _WorkbenchNotchState extends State<WorkbenchNotch>
  ...
  // ── Handle (always-visible drag bar) ──────────────────────────────────
